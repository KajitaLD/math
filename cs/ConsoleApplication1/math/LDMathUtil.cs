...
namespace live2d
{
    ...
    public class LDMathUtil
    {
        ...
        */
        ...
        public static LDPoint lerp(LDPoint from, LDPoint to, float t)
        {
            return (1 - t) * from + t * to;
        }
        /*
        ...
        */
        ...
        public static float inverseLerp(double from, double to, double value)
        {
        ...
        */
         ...
         * 4つの値の間を二次元線形補間する
         */
        public static float lerp2D(float from1, float to1, double t1, float from2, float to2, double t2)
        {
            float tmp1 = (float)(1 - t1) * from1 + (float)t1 * to1;
            float tmp2 = (float)(1 - t1) * from2 + (float)t1 * to2;
            return (float)((1 - t2) * tmp1 + t2 * tmp2);
        }
        ...
        */
        ...
        public static bool fuzzyCompare(float a, float b, float fuzz)
        {
            return Math.Abs(a - b) <= fuzz;
        }

        public static bool fuzzyCompare(double a, double b, float fuzz)
        {
            return Math.Abs(a - b) <= fuzz;
        }
